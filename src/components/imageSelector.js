...
const harvardFileArray = fileName.map((item, ind)=>`/public/assets/images/templates/Harvard${item}`)
const mitFileArray = fileName2.map((item, ind)=>`public/assets/images/templates/Mit/${item}`)
const modernFileArray = fileName3.map((item, ind)=>`/public/assets/images/templates/Modern/${item}`)
