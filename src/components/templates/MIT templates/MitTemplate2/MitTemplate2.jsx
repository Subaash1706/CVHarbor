...
const MitTemplate2 = React.forwardRef((props, ref) => {
                    ...
                    education.map((item, ind)=>{
                        ...
                        <div key={ind}>
                            ...
                            <FlexBox style={{justifyContent: 'space-between'}} direction='row'>
                                ...
                                <div>{item.end_date.includes('-') ? `${item.end_date.split('-')[1]} ${item.end_date.split('-')[0]}` : item.end_date}</div>
                            </FlexBox>
                            {item.accomplishments &&<OutwardList listItems={item.accomplishments}/>}
                        </div>
